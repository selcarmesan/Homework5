...
/**
 * Mock for pawns board which has a singular valid move at row 1 column 1.
 */
public class MockBoardOneValid implements PawnsBoardReadOnly {

  private final StringBuilder log;

  public MockBoardOneValid(StringBuilder log) {
    this.log = log;
  }
