...
/**
 * Mock class for a pawns board which has a predetermined deck of all 1 cost no influence cards.
 */
public class MockBoardChecking implements PawnsBoardReadOnly {

  private final StringBuilder log;

  public MockBoardChecking(StringBuilder log) {
    this.log = log;
  }
  ...
  public List<Card> getHand(Player player) {
    PawnsCard card = new PawnsCard("mock", 1, 1, new boolean[5][5]);
    return List.of(card, card, card);
  }
